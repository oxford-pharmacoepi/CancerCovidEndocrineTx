...
#       calculation for treatment-related outcomes in prostate cancer patients #
...
incidence_estimates_EndoDxOutcomes_in_prostate <- read_csv("0_DataPrep/incidence_estimates_EndoDxOutcomes_in_prostate.csv")

View(incidence_estimates_EndoDxOutcomes_in_prostate)

inc_data <- incidence_estimates_EndoDxOutcomes_in_prostate
...
inc_data_endo_dx_outcomes_in_prostate <- inc_data_final


# save General Pop----
save(inc_data_endo_dx_outcomes_in_prostate, file = here("0_DataPrep", "inc_data_endo_dx_outcomes_in_prostate.RData"))

write.csv(inc_data_endo_dx_outcomes_in_prostate, file=here("0_DataPrep", "inc_data_endo_dx_outcomes_in_prostate.csv"))
