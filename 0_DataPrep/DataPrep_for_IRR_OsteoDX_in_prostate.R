...
incidence_estimates_OsteoDx_in_prostate <- read_csv("0_DataPrep/Data/incidence_estimates_OsteoDx_in_Prostate_endo.csv")
View(incidence_estimates_OsteoDx_in_prostate)

inc_data <- incidence_estimates_OsteoDx_in_prostate
...
inc_data_OsteoDx_in_prostate <- inc_data_final


# save General Pop----
save(inc_data_OsteoDx_in_prostate, file = here("0_DataPrep", "Data", "inc_data_OsteoDx_in_prostate.RData"))

write.csv(inc_data_OsteoDx_in_prostate, file=here("0_DataPrep", "Data", "inc_data_OsteoDx_in_prostate.csv"))
