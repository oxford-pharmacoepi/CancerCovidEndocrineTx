...
incidence_estimates_EndoDxOutcomes_in_breastAI <- read_csv("0_DataPrep/incidence_estimates_EndoDxOutcomes_in_breastAI.csv")

View(incidence_estimates_EndoDxOutcomes_in_breastAI)

inc_data <- incidence_estimates_EndoDxOutcomes_in_breastAI
...
inc_data_endo_dx_outcomes_in_breast_AI <- inc_data_final


# save General Pop----
save(inc_data_endo_dx_outcomes_in_breast_AI, file = here("0_DataPrep", "inc_data_endo_dx_outcomes_in_breast_AI.RData"))

write.csv(inc_data_endo_dx_outcomes_in_breast_AI, file=here("0_DataPrep", "inc_data_endo_dx_outcomes_in_breast_AI.csv"))
