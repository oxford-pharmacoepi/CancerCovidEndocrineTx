...
incidence_estimates_OsteoDx_in_breastAI <- read_csv("0_DataPrep/Data/incidence_estimates_OsteoDx_in_BreastAI.csv")
View(incidence_estimates_OsteoDx_in_breastAI)

inc_data <- incidence_estimates_OsteoDx_in_breastAI
...
inc_data_OsteoDx_in_breastAI <- inc_data_final


# save General Pop----
save(inc_data_OsteoDx_in_breastAI, file = here("0_DataPrep", "Data", "inc_data_OsteoDx_in_breastAI.RData"))

write.csv(inc_data_OsteoDx_in_breastAI, file=here("0_DataPrep", "Data", "inc_data_OsteoDx_in_breastAI.csv"))
