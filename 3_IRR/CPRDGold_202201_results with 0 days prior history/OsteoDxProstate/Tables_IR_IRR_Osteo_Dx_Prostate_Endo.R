...
#                  prostate cancer patients on endocrine treatments            #
#                                                                              #
#                              Nicola Barclay                                  #
#                                20-06-2023                                    #
# ============================================================================ #
...
load(here("0_DataPrep", "Data", "inc_data_OsteoDx_in_prostate.RData"))
...
write.csv(ir_ci_all, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed_incidence_rates_OsteoDx_prostateEndo.csv"))
save(ir_ci_all, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed_incidence_rates_OsteoDx_prostateEndo.RData"))
...
write.csv(ir.post_ci, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed_incidence_rates_post_lockdown_OsteoDx_prostateEndo.csv"))
save(ir.post_ci, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed_incidence_rates_post_lockdown_OsteoDx_prostateEndo.RData"))
...
write.csv(ir_ci_pre_post, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed_incidence_rates_pre_post_lockdown_OsteoDx_prostateEndo.csv"))
save(ir_ci_pre_post, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed_incidence_rates_pre_post_lockdown_OsteoDx_prostateEndo.RData"))
...
Pretty_observed_IR_results_table <- flextable(ir_ci_pre_post_pivot) %>% theme_vanilla() %>% 
  set_caption(caption = "Incidence rates of treatment-related outcomes in prostate cancer patients on endocrine treatments in each of the time periods, stratified by age") %>% 
  width(width = 1.4) 

save(ir_ci_pre_post_pivot, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed incidence_rates_ir_ci_pre_post_pivot_OsteoDx_prostateEndo.RData"))
write.csv(ir_ci_pre_post_pivot, file=here("3_IRR", db.name, "OsteoDxProstate",  "Observed incidence_rates_ir_ci_pre_post_pivot_OsteoDx_prostateEndo.csv"))

save_as_docx('Pretty_observed_IR_results_table' = Pretty_observed_IR_results_table, path=here("3_IRR", db.name, "OsteoDxProstate",  "Observed incidence_rates_OsteoDx_prostateEndo.docx"))
...
#### Save IRR
write.csv(rate_ratios_table_formatted, file=here::here("3_IRR", db.name, "OsteoDxProstate",  "Observed IRR_OsteoDX_prostateEndo.csv"))
save(rate_ratios_table_formatted, file=here::here("3_IRR", db.name, "OsteoDxProstate",  "Observed IRR_OsteoDX_prostateEndo.RData"))
...
IRR_forest_osteoDx_Prostate_Endo =
  ...
  coord_flip()+
  ggtitle("Incidence Rate Ratios of Endocrine Treatment-Related Outcomes in Prostate Cancer Patients on Endocrine Treatments Across Lockdown Periods")+
