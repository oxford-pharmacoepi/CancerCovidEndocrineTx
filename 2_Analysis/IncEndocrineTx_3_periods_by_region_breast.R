...
save(inc_pre_eng, file = here("Results", db.name, "Regions", "inc_pre_eng.RData"))
...
save(inc_lock_eng, file = here("Results", db.name, "Regions", "inc_lock_eng.RData"))
...
save(inc_post_eng, file = here("Results", db.name, "Regions", "inc_post_eng.RData"))
...
save(inc_pre_NI, file = here("Results", db.name, "Regions", "inc_pre_NI.RData"))
...
save(inc_lock_NI, file = here("Results", db.name, "Regions", "inc_lock_NI.RData"))
...
save(inc_post_NI, file = here("Results", db.name, "Regions", "inc_post_NI.RData"))
...
save(inc_pre_scot, file = here("Results", db.name, "Regions", "inc_pre_scot.RData"))
...
save(inc_lock_scot, file = here("Results", db.name, "Regions", "inc_lock_scot.RData"))
...
save(inc_post_scot, file = here("Results", db.name, "Regions", "inc_post_scot.RData"))
...
save(inc_pre_wales, file = here("Results", db.name, "Regions", "inc_pre_wales.RData"))
...
save(inc_lock_wales, file = here("Results", db.name, "Regions", "inc_lock_wales.RData"))
...
save(inc_post_wales, file = here("Results", db.name, "Regions", "inc_post_wales.RData"))
...
IR_endocrineTx_by_region <- rbind(inc_pre_eng, inc_lock_eng, inc_post_eng, inc_pre_NI, inc_lock_NI, inc_post_NI, inc_pre_scot, inc_lock_scot, inc_post_scot,
                              inc_pre_wales, inc_lock_wales, inc_post_wales)

IR_endocrineTx_by_region <- IR_endocrineTx_by_region  %>%
  mutate(`Time` = factor(`Time`, levels=c("Pre-lockdown", "Lockdown","Post-lockdown"))) 

save(IR_endocrineTx_by_region, file = here("Results", db.name, "Regions", "Breast", "IR_endocrineTx_by_region.RData"))
...
IR_AIs_3_times_plot <- IR_endocrineTx_by_region %>%
  filter(denominator_cohort_id == 3) %>%
  filter(outcome_cohort_name == "AromataseInhibitors") %>%
...
ggsave(here("Results", db.name , "Regions", "Breast", "IR_AIs_3_times_plot.jpg"), IR_AIs_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)
ggsave(here("Results", db.name , "Regions", "Breast", "IR_AIs_3_times_plot.tiff"), IR_AIs_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)


# AromataseInhibitors withGnRHAgonistsOrAntagonists

IR_AIs_GnRH_3_times_plot <- IR_endocrineTx_by_region %>%
  filter(denominator_cohort_id == 3) %>%
  filter(outcome_cohort_name == "AromataseInhibitors_withGnRHAgonistsOrAntagonists_UPDATED") %>%
  ggplot(aes(x = Time, y=incidence_100000_pys,
             ymin = incidence_100000_pys_95CI_lower,
             ymax = incidence_100000_pys_95CI_upper, color=Region, group=Region)) +
  geom_point() + geom_line() +
...
IR_AIs_GnRH_3_times_plot


# Save the plot as jpg
ggsave(here("Results", db.name , "Regions", "Breast", "IR_AIs_GnRH_3_times_plot.jpg"), IR_AIs_GnRH_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)
ggsave(here("Results", db.name , "Regions", "Breast", "IR_AIs_GnRH_3_times_plot.tiff"), IR_AIs_GnRH_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)


# Tamoxifen_withGnRHAgonistsOrAntagonists_UPDATED

IR_TAM_GnRH_3_times_plot <- IR_endocrineTx_by_region %>%
  filter(denominator_cohort_id == 3) %>%
  filter(outcome_cohort_name == "Tamoxifen_withGnRHAgonistsOrAntagonists_UPDATED") %>%
  ggplot(aes(x = Time, y=incidence_100000_pys,
             ymin = incidence_100000_pys_95CI_lower,
             ymax = incidence_100000_pys_95CI_upper, color=Region, group=Region)) +
  geom_point() + geom_line() +
...
IR_TAM_GnRH_3_times_plot


# Save the plot as jpg
ggsave(here("Results", db.name , "Regions", "Breast", "IR_TAM_GnRH_3_times_plot.jpg"), IR_TAM_GnRH_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)
ggsave(here("Results", db.name , "Regions", "Breast", "IR_TAM_GnRH_3_times_plot.tiff"), IR_TAM_GnRH_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)


# Tamoxifen

IR_TAM_3_times_plot <- IR_endocrineTx_by_region %>%
  filter(denominator_cohort_id == 3) %>%
  filter(outcome_cohort_name == "Tamoxifen") %>%
  ggplot(aes(x = Time, y=incidence_100000_pys,
             ymin = incidence_100000_pys_95CI_lower,
             ymax = incidence_100000_pys_95CI_upper, color=Region, group=Region)) +
  geom_point() + geom_line() +
...
# Save the plot as jpg
ggsave(here("Results", db.name , "Regions", "Breast", "IR_TAM_3_times_plot.jpg"), IR_TAM_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)
ggsave(here("Results", db.name , "Regions", "Breast", "IR_TAM_3_times_plot.tiff"), IR_TAM_3_times_plot, dpi=900, scale = 1, width = 12, height = 9)



# JOIN THE FIGURES

IR_endocrineTx_breast_by_region_JOINED<-ggarrange(IR_AIs_3_times_plot, IR_AIs_GnRH_3_times_plot, IR_TAM_3_times_plot, IR_TAM_GnRH_3_times_plot, 
                                        align="hv", ncol=2, nrow=2,
                                        labels = c("A) Aromatase Inhibitors", "B) Aromatase Inhibitors with GnRH ", "C) Tamoxifen", "D) Tamoxifen with GnRH"),
...
IR_endocrineTx_breast_by_region_JOINED


# Save the plot as jpg
ggsave(here("Results", db.name , "Regions", "Breast", "IR_endocrineTx_breast_by_region_JOINED.jpeg"), IR_endocrineTx_breast_by_region_JOINED, dpi=900, scale = 1, width = 15, height = 9)
ggsave(here("Results", db.name , "Regions", "Breast", "IR_endocrineTx_breast_by_region_JOINED.tiff"), IR_endocrineTx_breast_by_region_JOINED, dpi=900, scale = 1, width = 15, height = 9)
